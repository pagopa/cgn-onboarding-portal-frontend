...
openapi-generator-cli generate -i ./src/api/api.yaml -g typescript-axios -o ./src/api/generated
openapi-generator-cli generate -i ./src/api/api_backoffice.yaml -g typescript-axios -o ./src/api/generated_backoffice
openapi-generator-cli generate -i ./src/api/api_public.yaml -g typescript-axios -o ./src/api/generated_public
