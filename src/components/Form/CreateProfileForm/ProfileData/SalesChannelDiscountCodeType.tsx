  ...
  >
    <div className="d-flex flex-column">
      <div className="form-check">
        ...
        <label className="text-sm font-weight-normal text-black" htmlFor="api">
          <span className="text-sm">
            <a href="https://docs.pagopa.it/documentazione-tecnica-portale-operatori-1.0.0/attuazione-della-convenzione/online-modello-api" target="_blank">API</a>: implementerò sul mio portale di e-commerce le
      ...
      <div className="form-check">
        ...
        >
          <span className="text-sm">
            <a href="https://docs.pagopa.it/documentazione-tecnica-portale-operatori-1.0.0/attuazione-della-convenzione/online-codice-sconto-statico" target="_blank">Con codice statico</a>: assocerò ad ogni agevolazione un
      ...
      <div className="form-check">
        ...
        >
          <span className="text-sm">
            <a href="https://docs.pagopa.it/documentazione-tecnica-portale-operatori-1.0.0/attuazione-della-convenzione/online-lista-di-codici-statici-bucket" target="_blank">Con lista di codici statici</a>: assocerò ad ogni
      ...
      <div className="form-check">
        ...
        >
          <span className="text-sm">
            <a href="https://docs.pagopa.it/documentazione-tecnica-portale-operatori-1.0.0/attuazione-della-convenzione/online-landing-page" target="_blank">Con link a landing page</a>: fornirò per ogni
