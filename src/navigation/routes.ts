...
export const EDIT_DISCOUNT = '/admin/operatori/agevolazioni/modifica/:discountId';
...
export const ADMIN_PANEL_CONVENZIONATI = '/admin/operatori/operatori-convenzionati';
